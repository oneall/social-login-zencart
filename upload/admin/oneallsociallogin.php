...
echo '<label style="margin:0 5px;" class="radioButtonLabel" for="api_connection_handler_curl">Use PHP CURL to communicate with the API <strong>(Default)</strong></label>';
?>
											<br />
	      						 	<?php
...
echo '<label style="margin:0 5px;" class="radioButtonLabel" for="api_connection_handler_fsockopen">Use PHP FSOCKOPEN to communicate with the API </label>';
?>
										</td>
      						 </tr>
      						 <tr>
...
echo '<label style="margin:0 5px;" class="radioButtonLabel" for="api_connection_protocol_https">Communication via HTTPS on port 443 <strong>(Default)</strong></label>';
?>
										<br />
											<?php
echo zen_draw_radio_field('api_connection_protocol', 'http', ($api_connection_protocol == 'http'), '', 'id="api_connection_protocol_http"');
echo '<label style="margin:0 5px;" class="radioButtonLabel" for="api_connection_protocol_http">Communication via HTTP on port 80</label>';
?>
								</td>
      						 </tr>
      					</table>
...
echo '<label style="margin:0 15px 0 5px;" class="radioButtonLabel" for="send_mail_customers_0">No</label>';
?>

									<?php
echo zen_draw_radio_field('send_mail_customers', '1', ($send_mail_customers != '0'), '', 'id="send_mail_customers_1"');
echo '<label style="margin:0 15px 0 5px;" class="radioButtonLabel" for="send_mail_customers_1">Yes, send email to new customers</label>';
?>
								</td>
      						 </tr>
      						 <tr>
...
echo '<label style="margin:0 15px 0 5px;"  class="radioButtonLabel" for="send_mail_admin_0">No</label>';
?>
	      							<?php
echo zen_draw_radio_field('send_mail_admin', '1', ($send_mail_admin != '0'), '', 'id="send_mail_admin_1"');
echo '<label style="margin:0 15px 0 5px;"  class="radioButtonLabel" for="send_mail_admin_1">Yes, inform admin of new customers</label>';
?>
								</td>
      						 </tr>
      					</table>
...
echo zen_draw_radio_field('providers[' . $provider_key . ']', '1', in_array($provider_key, $enabled_providers), '', 'id="provider-' . $provider_key . '-1"');
    echo '<label style="margin:0 15px 0 5px;" class="radioButtonLabel" for="provider-' . $provider_key . '-1">Enabled</label>';
    ?>

      						 					<?php
echo zen_draw_radio_field('providers[' . $provider_key . ']', '0', !in_array($provider_key, $enabled_providers), '', 'id="provider-' . $provider_key . '-0"');
    echo '<label style="margin:0 15px 0 5px;" class="radioButtonLabel" for="provider-' . $provider_key . '-0">Disabled</label>';
    ?>
      						 				</td>
      						 			</tr>
      								<?php
